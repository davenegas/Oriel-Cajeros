...
class Data_Provider{
    ...
    public function __construct(){
       ...
       try{
            ...
            $this->mvc_bd_nombre   = "bd_Control_Seguimiento_Cajero";
    ...
    public function inserta_datos($table,$campos,$valores){
        ...
        $cadena_sql = str_replace(")","]",$cadena_sql);
        //Establece que la table modificada es de bd_Control_Seguimiento_Cajero
        $table="bd_Control_Seguimiento_Cajero. ".$table;
